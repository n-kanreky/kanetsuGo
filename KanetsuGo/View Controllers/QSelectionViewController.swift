...
class QSelectionViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    var questions =
        ...
        [["注意","意見","同意","結果","結論","天然","燃料","記念","過去","孤独","古代","管理","楽観","連絡","準備","首都","観察","宇宙","歴史","破産"],//Group 1
            ...
            ["反映","反対","違反","反省"], //Group 9 反を含む　６語 -2（反応、反射） 4語
            ["地面","地球","地上","地震","湿地"],//Group 10 地を含む
            ["費用","人件費","食費","旅費","学費","光熱費"],  //Group 11 費を含む
            ["活動","動詞","動物","動作"],  //Group 12 費を含む
    ...
    var katakana =
        [["友達にチュウイする","反対イケンを言う","意見にドウイする","試験のケッカ","ケツロンを先に言う","テンネンの温泉（おんせん）","ネンリョウ費（ひ）","キネン日（び）","カコのデータ","コドクなくらし","コダイの文明（ぶんめい）","カンリする","ラッカン的（てき）","レンラクする","ジュンビする","日本のシュト","花をカンサツする ","ウチュウ飛行士","日本のレキシ","会社がハサンする"], // Group 1
            ...
            ["セイゾンしている","セイカツする","セイメイ保険（ほけん）","宇宙からセイカンする"], //Group 6
            ["ブンガクを勉強する",
             "テツガクはむずかしい",
             "イガクが進歩する",
             "スウガクが得意（とくい）だ",
    ...
    var vietnamese =
           [["chú ý","ý kiến","đồng ý","Kết quả","Kết luận","thiên nhiên","Nhiên liệu","kỷ niệm","quá khứ","cô đơn","cổ đại","Quản lý","Lạc quan","liên lạc","Chuẩn bị","thủ đô","Quan sát","Vũ trụ","Lịch sử","phá sản"], //Group 1
            ...
            ["Sự sống còn","sống","Cuộc sống","Sống sót"], //Group 6
            ["Văn học",
             "triết học",
             "y học",
             "toán học",
            ...
            ["Phản ánh","Phản đối","Vi phạm","Sự phản chiếu"],//Group9
            ["Mặt đất","Trái đất","Trên mặt đất","Một trận động đất","Đất ngập nước"],//Group10
            ["Chi phí","Chi phí nhân sự","Chi phí ăn uống","Chi phí đi lại","Học phí","Phí tiện ích"],//Group11
            ["Hoạt động","động từ","Động vật","động tác"],//Group12
    ...
    var pronunciationJ =
        [["Chuui","Iken","Doui","Kekka","Ketsuron","Tennen","Nenryou","Kinen","Kako","Kodoku","Kodai","Kanri","Rakkan","Renraku","Junbi","Shuto","Kansatsu","Uchuu","Rekishi","Hasan"],//Groupo 1
            ...
            ["Seizon","Seikatsu","Seimei","Seikan"], //Group 6
            ["Bungaku",
             "Tetsugaku",
             "Igaku",
             "Suugaku",
            ...
            ["Hanei","Hantai","Ihan","Hansei"], //Group 9
            ["Jimen","Chikyuu","Chijou","Jishin","Shicchi"], //Group 10
            ["Hiyou","Jinkenhi","Shokuhi","Ryohi","Gakuhi","Kounetsuhi"], //Group 11
            ["Katsudou","Doushi","Doubutsu","Dousa"], //Group 12
...
//Reibun2
        ...
        //Group 15
           [["交通信号の色は赤、青、黄色だ。"],
            ["私は彼を信頼して、お金を貸した。"],
            ["信者とは、ある宗教を信仰している人のことだ。"],
            ["この山は昔から神が住む山として、信仰の対象となっている。"]],
        ...
        [[["このきかいを　つかうときは　ちゅういが　ひつようだ。"],
         ...
         //Group 2
            [["わたしは　こんしゅうの　かようびに　たろうさんと　テニスを　します。"],
             ...
             ["わたしは　らいしゅう、とうきょうへ　いきます。"],
             ["わたしは　まいしゅう　つまに　はなを　かいます。"],
...
//Furigana 1
            ...
            [["わたしの　せんこうは　にほんぶんがくだ。"],
             ...
             ["かれは  ゆうめいな　すうがくしゃだ。"],
             ["わたしは　だいがくで　やくがくを　まなんでいる。"],
             ["かがくと　かがくは、どちらも　「カガク」と　はつおんする。"],
            ...
            [["しんごうを　むしするのは　きけんだ。"],
             ["かれは  みなに　しんらいされている。"],
             ["かれは　しんじゃの　つみの　こくはくを　きいた。"],
             ["ぶっきょうとにとって　しんこうとは、ほとけを　しんじて　うやまうことだ。"]],
            
            //Group 16
            [["わたしは　しょくばの　にんげんかんけいに　くるしんでいる。"],
             ["パーティーには かなりの にんずうが　あつまった。"],
             ["にほんを　おとずれる　がいこくじんの　かずが　ふえた。"],
             ["あなたの　がっこうには　にほんじんの　せんせいが　なんにんぐらい　いますか。？"],
        ...
        [[["ねっちゅうしょうに　ちゅういしてください。"],
         ...
         //Group 2
            ...
            [["このかいしゃでは、つうしんシステムを　かいはつしている。"],
             ["このでんわには　つうちきのうが　あるので、だれから　かかってきたか　わかる。"],
             ["つうやくの　しごとは　つかれる。"],
...
//Furigana 2
            ...
            [["『げんじものがたり』は　にほんの　こてんぶんがくの　さいこうけっさくだ。"],
             ...
             ["にほんには　しょうがっこう、ちゅうがっこう、こうとうがっこうなどが　ある。"],
             ["だいがくを　そつぎょうご、わたしは　だいがくいん　しゅうしかていに　すすんだ。"]],
            //Group 8
            ...
            [["このシステムは　ひように　たいして　こうかが　たかい。"],
             ["らいねんど　よさん　けいかくでは　じんけんひを　みなおすことに　なった。"],
            ...
            [["こうつうしんごうのいろは　あか、あお、きいろだ。"],
             ...
             ["しんじゃとは　あるしゅうきょうを　しんこうしている　ひとのことだ。"],
             ["このやまは　むかしから　かみが　すむ　やまとして　しんこうの　たいしょうと　なっている。"]],
            
            //Group 16
            [["にんげんは　しゃかいてきな　どうぶつだ。"],
             ["このカウンターは、みせに　きたひとの　にんずうを　じどうてきに　おしえてくれる。"],
...
//Vetonamese 1
         ...
         //Group 6
           [["Xác nhận sự sống còn của đứa trẻ."],
            ["Tôi đang sống ở Nhật Bản như một sinh viên quốc tế."],
            ["Trận động đất lớn cướp đi nhiều mạng sống."],
            ["Các phi hành gia sống sót một cách an toàn."]],
         //Group 7
           [["Chuyên ngành của tôi là văn học Nhật Bản."],
            ...
            ["Hóa học và khoa học đều phát âm ’Kagaku’."],
        ...
        //Group 12
           [["Các hoạt động cứu trợ được tiến hành ở nước ngoài."],
            ...
            ["Chị tôi bắt chước động tác của tôi và di chuyển cơ thể của cô ấy."]],
        ...
        //Group 15
           [["Bỏ qua tín hiệu là nguy hiểm."],
            ...
            [" Ông đã nghe về sự thú nhận tội lỗi của các tín đồ."],
        ...
        //Group 16
           [["Tôi đau khổ cho mối quan hệ của con người trong công việc."],
            ...
            ["Có bao nhiêu giáo viên Nhật Bản trong trường của bạn?"],
    ...
    var reibunV2 =
        ...
        //Group 6
           [["Có khả năng các dạng sống tồn tại trong vũ trụ."],
            ["Tôi muốn sống một cuộc sống xa xỉ ở nước ngoài."],
            ["Tôi đang nghiên cứu khoa học đời sống."],
            ["Tôi cầu nguyện cho những người sống sót của những người leo núi sống sót."]],
        //Group 7
           [["Truyện Genji là 1 kiệt tác văn học cổ điển của Nhật Bản."],
            ["Chuyên môn của ông là triết học."],
            ...
            ["Có trường tiểu học, trường trung học cơ sở và trường trung học ở Nhật Bản."],
...
//Vetonamese 2
        ...
        //Group 11
           [["Hệ thống này hiệu quả về chi phí."],
            ...
            ["Chi phí tiện ích là chi phí điện và gas."]],
        ...
        //Group 15
           [["Đèn giao thông có màu đỏ, xanh và vàng."],
            ["Tôi tin tưởng anh ta và cho vay tiền."],
            ["Người tin Chúa nói đến người tin vào tôn giáo."],
            ["Ngọn núi này từ lâu đã là đối tượng của đức tin như một ngọn núi nơi Chúa sống."]],
